...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'X:\\training-materials\\PsychoPy-Part2\\demos\\3-Branching-example\\experiment.psyexp',
...
Question_text = visual.TextStim(win=win, name='Question_text',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0);
Rating_scale = visual.TextStim(win=win, name='Rating_scale',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Do you really mean that?? (Y/N)',
    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0);
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [Question_text, Rating_scale, question_answer]
    ...
    extra_answer = event.BuilderKeyResponse()
    # keep track of which components have finished
    extra_questionComponents = [text_3, extra_answer]
    ...
    while continueRoutine:
        ...
        if t >= 0.0 and extra_answer.status == NOT_STARTED:
            # keep track of start time/frame for later
            extra_answer.tStart = t
            extra_answer.frameNStart = frameN  # exact frame index
            extra_answer.status = STARTED
            # keyboard checking is just starting
            win.callOnFlip(extra_answer.clock.reset)  # t=0 on next screen flip
            event.clearEvents(eventType='keyboard')
