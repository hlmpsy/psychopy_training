...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), October 15, 2015, at 10:23
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='T:\\admin\\Technical\\training\\PsychoPy-Part2\\demos\\1-Nested-loop\\experiment.psyexp',
...
colour_title = visual.TextStim(win=win, ori=0, name='colour_title',
    text='Colour =',    font='Arial',
    pos=[0, 0.9], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
colour_text_obj = visual.TextStim(win=win, ori=0, name='colour_text_obj',
...
fruit_title = visual.TextStim(win=win, ori=0, name='fruit_title',
    text='Fruit =',    font='Arial',
    pos=[0, 0.9], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
fruit_text = visual.TextStim(win=win, ori=0, name='fruit_text',
    text='default text',    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0)
...
combined_text = visual.TextStim(win=win, ori=0, name='combined_text',
    text='default text',    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color=1.0, colorSpace='rgb', opacity=1,
    depth=0.0)
...
fruit_loop = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath='T:\\admin\\Technical\\training\\PsychoPy-Part2\\demos\\1-Nested-loop\\experiment.psyexp',
...
for thisFruit_loop in fruit_loop:
    ...
    for thisColour_loop in colour_loop:
        ...
        # keep track of which components have finished
        coloursComponents = []
        coloursComponents.append(colour_title)
        coloursComponents.append(colour_text_obj)
        coloursComponents.append(key_resp_3)
        ...
        while continueRoutine:
            ...
            if t >= 0.0 and colour_title.status == NOT_STARTED:
                # keep track of start time/frame for later
                colour_title.tStart = t  # underestimates by a little under one frame
            ...
            if t >= 0.0 and colour_text_obj.status == NOT_STARTED:
                # keep track of start time/frame for later
                colour_text_obj.tStart = t  # underestimates by a little under one frame
        ...
        # keep track of which components have finished
        fruitComponents = []
        fruitComponents.append(fruit_title)
        fruitComponents.append(fruit_text)
        fruitComponents.append(key_resp_4)
        ...
        while continueRoutine:
            ...
            if t >= 0.0 and fruit_title.status == NOT_STARTED:
                # keep track of start time/frame for later
                fruit_title.tStart = t  # underestimates by a little under one frame
            ...
            if t >= 0.0 and fruit_text.status == NOT_STARTED:
                # keep track of start time/frame for later
                fruit_text.tStart = t  # underestimates by a little under one frame
        ...
        # keep track of which components have finished
        combinedComponents = []
        combinedComponents.append(combined_text)
        combinedComponents.append(key_resp_5)
        ...
        while continueRoutine:
            ...
            if t >= 0.0 and combined_text.status == NOT_STARTED:
                # keep track of start time/frame for later
                combined_text.tStart = t  # underestimates by a little under one frame
